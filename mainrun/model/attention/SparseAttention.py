...
#         self.register_buffer("tril", self.blockspace(block_size , cfg.blockspace))
...
#         elif attn_mode == 'strided':
#             bT_ctx = block_size // local_attn_ctx
...
#         layout = torch.from_numpy(layout).to(dtype=torch.bool)
#         return layout
...
#         n_head=8,
#         dropout=0.1,
#         blockspace=block_config
#     )

#     block_size = 256
#     sparse_attn = SparseAttention(block_size , sparse_config)
#     layout = sparse_attn.tril
#     print("Layout shape:", layout.shape)
#     print("Sample layout for head 0:\n", layout[0])